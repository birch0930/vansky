...
public class NewsSearch extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String searching_word = request.getParameter("key");
		
		if(searching_word != null && !searching_word.equals("")){
			searching_word = searching_word.trim();
		}
		String value = "search";
		request.setAttribute("keyword", searching_word);
